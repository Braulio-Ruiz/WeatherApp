...
/**
 * Clase City: Representa una ciudad con nombre, coordenadas geográficas y un
 * ícono asociado al clima.
 * Incluye validación de coordenadas y permite la representación textual de sus
 * datos.
 */
public class City {
     ...
     * Crea una instancia de `City` con el nombre, latitud y longitud especificados.
     ...
     * @param name        Nombre de la ciudad.
     * @param latitude    Latitud de la ciudad (debe estar entre -90 y 90 grados).
     * @param longitude   Longitud de la ciudad (debe estar entre -180 y 180
     *                    grados).
     * @param weatherIcon ID del recurso drawable que representa el ícono del clima.
     */
     ...
     * @return `true` si la longitud está entre -180 y 180 grados; de lo contrario,
     *         `false`.
     */
