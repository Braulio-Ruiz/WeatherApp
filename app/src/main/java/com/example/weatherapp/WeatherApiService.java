...
//Interfaz `WeatherApiService`: Define los métodos para interactuar con la API de clima utilizando Retrofit.
...
public interface WeatherApiService {
    ...
    // servicio.
    // - Es un parámetro obligatorio que asegura el acceso autorizado a los datos.
    // @return: Un objeto {@link Call} que encapsula la solicitud HTTP y la
    // respuesta.
    // - El tipo genérico de `Call` es {@link WeatherResponse}, que es el modelo de
    // datos
